...
(ryo-modal-keys
 ...
 ("p" xah-kill-word :name "kill word")
 ...
 ("t" ryo-command-mode-disable :name "insert")
 ...
 ("b" set-mark-command :name "set mark")

 ;; right hand
 ("j" undo-tree-undo :name "undo")
 ("J" undo-tree-redo :name "redo")
