...
;; this file is derived from one originally written by Xah Lee, which was distributed as xah-fly-keys.el
;; main changes are the removal of keybinding methods leaving only the functions
;;
;; Copyright © 2013-2017, by Xah Lee
;; Copyright © 2018, by Henkjan Gersen

;; Original Author: Xah Lee ( http://xahlee.info/ )
;; License: GPL v3
